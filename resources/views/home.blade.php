                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-7 text-right">
                                    <h5 class="card-title font-14">Total Offices</h5>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-7 text-right">
                                    <h5 class="card-title font-14">Total Tenents</h5>
                                    <h4 class="mb-0">60</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-7 text-right">
                                    <h5 class="card-title font-14">Staff</h5>
                                    <h4 class="mb-0">13</h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card m-b-30 quote-bg">
                        ...
                        <div class="card-body text-center">
                            <img src="{{asset('assets/images/general/school_quote.svg')}}" class="img-fluid my-3" width="150" alt="school quote">
                ...
                <div class="card-header">                                
                    <div class="row align-items-center">
                        <div class="col-6 col-lg-9">
                            <h5 class="card-title mb-0">Recent Rents</h5>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{asset('assets/images/users/men.svg')}}" class="img-fluid" width="40" alt="hod"></td>
                                    <td>{{$employee->name}}</td>
                                    <td>{{$employee->email}}</td>
                                    <td>{{$employee->role ? $employee->role->name : ''}}</td>
                                    <td>@if ($employee->last_login)
                <span class="badge @if(date('Y-m-d', strtotime("-30 day")) < date('Y-m-d', strtotime($employee->last_login['created_at']))) badge-success-inverse @else badge-secondary @endif">          
